var core = {
  "i18n": function (id, substitutions) {
    if (chrome.i18n && chrome.i18n.getMessage) {
      const message = chrome.i18n.getMessage(id, substitutions);
  ...
  "load": function () {
    ...
    app.contextmenu.create({
      "contexts": ["action"],
      "title": core.i18n("contextMenuTestWebRTCLeak"),  
  ...
  "action": {
    ...
    "update": function () {
      ...
      app.button.title(null, core.session.allowlisted ? core.i18n("actionTitleOffOnSite") : core.i18n("actionTitleProtection", state === "enabled" ? core.i18n("stateOn") : core.i18n("stateOff")));
      /*  */
      const options = {};
